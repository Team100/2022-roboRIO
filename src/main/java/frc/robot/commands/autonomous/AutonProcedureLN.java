...
public class AutonProcedureLN extends SequentialCommandGroup {
    /** Creates a new AutonProcedure. */
    public AutonProcedureLN(Drivetrain drivetrain, Intake intake, Indexer indexer, Shooter shooter) {
