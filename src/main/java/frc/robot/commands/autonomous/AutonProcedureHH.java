...
public class AutonProcedureHH extends SequentialCommandGroup {
    ...
    public AutonProcedureHH(Drivetrain drivetrain, Intake intake, Indexer indexer, Shooter shooter) {//requires being set in a spot at startup it can sink two threes
